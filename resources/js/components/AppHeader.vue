                            ...
                            <div class="flex h-full flex-1 flex-col justify-between space-y-4 py-6">
                                <nav class="-mx-3 space-y-1">
                                    <template v-for="item in mainNavItems" :key="item.title">
                                        <Link v-if="item.visible" :href="item.href"
                                ...
                                <div class="flex flex-col space-y-4">
                                    <template v-for="item in rightNavItems" :key="item.title">
                                        ...
                                        <a v-if="item.visible" :href="item.href" target="_blank"
                    ...
                    <NavigationMenu class="ml-10 flex h-full items-stretch">
                        <NavigationMenuList class="flex h-full items-stretch space-x-2">
                            <NavigationMenuItem v-for="(item, index) in mainNavItems" :key="index"
                                ...
                                <Link :href="item.href" v-if="item.visible">
                                <NavigationMenuLink
                ...
                <div class="ml-auto flex items-center space-x-2">
                    <div class="relative flex items-center space-x-1">
                        ...
                        <div class="hidden space-x-1 lg:flex">
                            <template v-for="item in rightNavItems" :key="item.title">
                                <TooltipProvider :delay-duration="0" v-if="item.visible">
                                    <Tooltip>
                                        <TooltipTrigger>
