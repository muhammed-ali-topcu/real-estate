...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/ali/Development/real-estate/public/storage' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./home/ali/Development/real-estate/public/storage','laravel-impersonate.session_key','laravel-impersonate.session_guard',
'laravel-impersonate.session_guard_using','laravel-impersonate.default_impersonator_guard','laravel-impersonate.take_redirect_to','laravel-impersonate.leave_redirect_to','logging.default',
...
'telescope.watchers.Laravel\\Telescope\\Watchers\\ViewWatcher','view.paths','view.compiled','concurrency.default','cors.paths',
...
'hashing.rehash_on_login','inertia.ssr.enabled','inertia.ssr.url','inertia.testing.ensure_pages_exist','inertia.testing.page_paths',
...
'password.confirm','logout','admin.users.index','admin.users.create',
'admin.users.store','admin.users.edit','admin.users.update','admin.users.destroy','admin.properties.index',
'admin.properties.create','admin.properties.store','admin.properties.edit','admin.properties.update','admin.properties.destroy',
'impersonate','impersonate.leave','storage.local',);
...
'validation.ulid','validation.uuid','validation.custom.attribute-name.rule-name','ar.0','validation.end_with',
'validation.password','validation.begin_with','en.0','php_ar.0','php_en.0',
'php_tr.0','tr.0','validation.custom.x.regex',);
