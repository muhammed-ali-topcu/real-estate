...
class TurkiyeCiteiesSeeder extends Seeder
{
    /**
    ...
    {
        $turkiye = Country::create(['name' => 'Türkiye']);
        foreach ($this->_getCitiesArray() as $city) {
        ...
        foreach($this->_getDistricsArray() as $district){
    ...
    private function _getCitiesArray(): array
    {
        return [
            ["id" => "15", "name" => "BURDUR"],
    ...
    private function _getDistricsArray(): array
    {
        return  [
            [
                "id"    => "1757",
